...
exports.editUserDetails = async (req, res) => {
  ...
  const { firstname, lastname, email, phoneNumber, country, address, city, state, profilePicture } = req.body;
...
exports.disableUser = async (req, res) => {
  ...
  try {
    ...
    return res.status(200).json({ message: 'User disabled successfully', user });
  } catch (error) {
