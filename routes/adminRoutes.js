...
router.post('/clone-loan/:loanId', verifyToken, loanApplicationController.cloneLoanApplication);
router.post('/close-loan/:loanId', verifyToken, loanApplicationController.closeLoanApplication);
router.post('/suspend-loan/:loanId', verifyToken, loanApplicationController.suspendLoanApplication);
